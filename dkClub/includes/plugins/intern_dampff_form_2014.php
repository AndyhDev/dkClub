...
function plugin_intern_dampff_form_2014(){
    ...
    <table>
      ...
      <tr>
        <td>
          <input type='checkbox' name='Dienstag_Abbau' Value='X' $di/>   Dienstag - Abbau 
        </td>
        <td>
        </td>
      </tr>
    ...
    <table>
      ...
      <tr>
        <td>
          <input type='checkbox' name='Montag__Vormittag_Personal' Value='X' />   Montag - Vormittag 
        </td>
        <td>
          <input type='checkbox' name='Montag_Nachmittag_Personal' Value='X' />   Montag - Nachmittag
        </td>
      </tr>
      <tr>
        <td>
          <input type='checkbox' name='Dienstag_Abbau' Value='X' />   Dienstag - Abbau
        </td>
        <td>
        </td>
      </tr>
